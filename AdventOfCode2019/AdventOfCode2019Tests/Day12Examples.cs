...
namespace AdventOfCode2019Tests
{
	class Day12Examples
	{
		...
		public void Example1()
		{
			...
			int energyAfterIterations;
			long returnToOrigin;
			Day12.Problem(10, moonStrings, out energyAfterIterations,out returnToOrigin);
		...
		public void Example2()
		{
			...
			int energyAfterIterations;
			long returnToOrigin;
			Day12.Problem(100, moonStrings, out energyAfterIterations, out returnToOrigin);
